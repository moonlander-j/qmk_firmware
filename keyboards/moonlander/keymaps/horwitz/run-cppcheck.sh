...
cppcheck --enable=all \
    ...
    "--suppress=unusedFunction:keyboards/moonlander/keymaps/horwitz/dance.c" \
    "--suppress=constParameterPointer:keyboards/moonlander/keymaps/horwitz/dance.c" \
    --check-level=exhaustive \
    --error-exitcode=1 \
    keyboards/moonlander/keymaps/horwitz/keymap.c \
    keyboards/moonlander/keymaps/horwitz/dance.c \
