...
/*
 * Generated code: this comment and the 164 lines following it were generated by
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMPAD] = LAYOUT_moonlander(
        ...
        TG(_J2),            TOGGLE_LAYER_COLOR, RGB_TOG,            RGB_MOD,            MOON_LED_LEVEL,     XXXXXXX,                                                                        XXXXXXX,            KC_P1,              KC_P2,              KC_P3,              KC_PENT,            XXXXXXX,
