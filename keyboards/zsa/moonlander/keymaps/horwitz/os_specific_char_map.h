...
// BEGIN GENERATED by ProcessRecordUserUnicodeCases.getMaxSeqLenDefine in qmk-tools (1 line, not counting BEGIN/END)
#define MAX_SEQ_LEN 4
// END GENERATED by ProcessRecordUserUnicodeCases.getMaxSeqLenDefine in qmk-tools
...
// BEGIN GENERATED by ProcessRecordUserUnicodeCases.getKcMinMaxDefines in qmk-tools (2 lines, not counting BEGIN/END)
#define OS_SPECIFIC_CHAR_MAP_KC_MIN ACUTE_A
#define OS_SPECIFIC_CHAR_MAP_KC_MAX UP_ARROW
// END GENERATED by ProcessRecordUserUnicodeCases.getKcMinMaxDefines in qmk-tools
