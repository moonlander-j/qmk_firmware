 ...
 * ProcessRecordUserUnicodeCases.getMaxSeqLenDefine in qmk-tools
 */
...
/*
 * Generated code: this comment and the 2 lines following it were generated by
 * ProcessRecordUserUnicodeCases.getKcMinMaxDefines in qmk-tools
 */
