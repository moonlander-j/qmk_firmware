...
enum custom_keycodes {
    ...
    // BEGIN GENERATED by ProcessRecordUserUnicodeCases.toCustomKeycodesEnumBlock in qmk-tools (101 lines, not counting BEGIN/END)
    ACUTE_A,
    ACUTE_E,
    ACUTE_I,
    ACUTE_O,
    ...
    TM_SIGN,
    UP_ARROW,
    // END GENERATED by ProcessRecordUserUnicodeCases.toCustomKeycodesEnumBlock in qmk-tools
    ...
    PLAY_ZELDA,
    PLAY_JT,
    // BEGIN GENERATED by SongTable.getPlaySongKeycodes in qmk-tools (81 lines, not counting BEGIN/END)
    PLAY_SONG_00,
    PLAY_SONG_01,
    PLAY_SONG_02,
    PLAY_SONG_03,
    ...
    // END GENERATED by SongTable.getPlaySongKeycodes in qmk-tools
    PAREN_P,
    BRACKET_P,
    BRACE_P,
    QUOTE_P,
