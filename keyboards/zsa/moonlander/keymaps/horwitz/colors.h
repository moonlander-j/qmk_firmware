...
// clang-format off
// BEGIN GENERATED by Colors.generateColorsH in qmk-tools (22 lines, not counting BEGIN/END)
...
#define HSV_ZELDA_CART    32, 189, 212 // #D4AD37 (metallic gold; approximate--not clear what to use for exact cartridge color)
...
#define HSV_PRINCE_PURP  193, 128, 196 // #9762C4 (original: #9662C4 (_Purple Rain_ purple))
#define HSV_LILAC        213,  48, 200 // #C8A2C8
//#define HSV_LIGHT_PINK   249,  73, 255 // #FFB6C0 (original: #FFB6C1)
// END GENERATED by Colors.generateColorsH in qmk-tools
